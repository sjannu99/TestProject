...
function getConnection() {
	...
	global $db_TestProject_db_Url, $db_TestProject_db_User, $db_TestProject_db_Pass, $db_TestProject_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_TestProject_db_Url.";dbname=".$db_TestProject_db_DbName, $db_TestProject_db_User, $db_TestProject_db_Pass);
